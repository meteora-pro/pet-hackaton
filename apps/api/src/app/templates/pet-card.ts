...
export class PetCard {
  ...
  fillData(): void {
    const pet: Pet = {
      cardNumber: '155x2',
      vacinations: [
        { date: new Date(), serialNumber: '12ss3U', vacineName: 'Нобивак 221' },
        { date: new Date(), serialNumber: '124U', vacineName: 'Нобивак 2' },
        { date: new Date(), serialNumber: '125U', vacineName: 'Нобивак 3' },
      ],
      parasiteTreatments: [
        { date: new Date(), medicineDose: '2', medicineName: 'Нобивак 221' },
        { date: new Date(), medicineDose: '2.5', medicineName: 'Нобивак 2' },
        { date: new Date(), medicineDose: '4', medicineName: 'Нобивак 3' },
      ],
      healthchecks: [
        { date: new Date(), weight: 2.3, anamnesis: 'Нормально' },
        { date: new Date(), weight: 12, anamnesis: 'Все хорошо' },
      ],
    } as Pet;
